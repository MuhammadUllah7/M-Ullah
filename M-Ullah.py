...
\033[1;92mFb \033[1;93m: مَــــحـمد الـــلّٰـــه احـــــمدزۓ
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/M.ULLAH.BAAP.KI.ID.HA.TERY')
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;32m[M-ULLAH-OK😎]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ...
                        print '\x1b[1;31m[M-ULLAH-CP🤦🏻‍♀️] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
